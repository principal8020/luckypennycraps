      ...
      <section className="mx-auto max-w-[1500px] px-3 py-4 pb-28 sm:px-5 sm:py-6 sm:pb-28">
        ...
        <div className="mt-4 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-[#c6d4ca] bg-white px-4 py-3 shadow-[0_8px_22px_rgba(20,60,43,.05)]">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/" className="rounded-lg border border-emerald-700 px-4 py-2 text-xs font-black text-emerald-900 hover:bg-emerald-50">Back to Games</Link>
            <Link href="/blackjack" className="rounded-lg border border-amber-400 bg-amber-50 px-4 py-2 text-xs font-black text-amber-800 hover:bg-amber-100">Play Blackjack</Link>
