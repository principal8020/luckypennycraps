...
export default function HitOrStandPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6f2e8] text-[#17392b]">
      ...
      <article>
        <header className="border-b border-[#d8d2c2] bg-[radial-gradient(circle_at_18%_10%,rgba(56,189,248,.16),transparent_34%),radial-gradient(circle_at_84%_20%,rgba(245,158,11,.14),transparent_28%)]">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-10 sm:px-8 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div className="min-w-0">
            ...
            <section className="mt-9">
              ...
              <h2 className="mt-2 text-3xl font-black text-[#123b2a]">Read the dealer before judging your own hand</h2>
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5">
                  <div className="text-sm font-black uppercase tracking-[0.12em] text-emerald-700">Dealer shows 2–6</div>
                  <h3 className="mt-2 text-xl font-black text-[#123b2a]">Make the dealer draw</h3>
                ...
                <div className="rounded-2xl border border-sky-200 bg-sky-50 p-5">
                  <div className="text-sm font-black uppercase tracking-[0.12em] text-sky-700">Dealer shows 7–A</div>
                  <h3 className="mt-2 text-xl font-black text-[#123b2a]">Assume you need improvement</h3>
                  <p className="mt-3 text-sm font-medium leading-6 text-slate-700">
            ...
            <section className="mt-9">
              <h2 className="text-3xl font-black text-[#123b2a]">Hard-hand hit or stand chart</h2>
              ...
              <div className="mt-4 overflow-x-auto rounded-2xl border border-[#b9cbbf] bg-white shadow-[0_12px_30px_rgba(21,62,43,.07)]">
            ...
            <section className="mt-9 rounded-2xl border border-red-200 bg-red-50 p-5 sm:p-6">
              <div className="text-[10px] font-black uppercase tracking-[0.16em] text-red-700">The hand everyone argues with</div>
              <h2 className="mt-2 text-3xl font-black text-red-950">What should you do with 16?</h2>
            ...
            <section className="mt-9">
              <h2 className="text-3xl font-black text-[#123b2a]">Soft hands get their own rules</h2>
              <p className="mt-4 text-base font-medium leading-7 text-slate-700">
            ...
            <section className="mt-9">
              <h2 className="text-3xl font-black text-[#123b2a]">Six decisions in the wild</h2>
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {examples.map((example) => (
                  <div key={`${example.player}-${example.dealer}`} className="rounded-2xl border border-[#c6d4ca] bg-white p-5 shadow-[0_10px_24px_rgba(21,62,43,.06)]">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <div className="text-[9px] font-black uppercase tracking-[0.12em] text-emerald-700">You vs. dealer</div>
                        <div className="mt-1 text-lg font-black text-[#123b2a]">{example.player} vs. {example.dealer}</div>
                      </div>
                      <span className={`rounded-lg px-3 py-2 text-xs font-black uppercase ${example.tone === "emerald" ? "bg-emerald-100 text-emerald-800" : "bg-sky-100 text-sky-800"}`}>
                        {example.action}
                      </span>
                    </div>
                    <p className="mt-3 text-sm font-medium leading-6 text-slate-600">{example.explanation}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="mt-9 rounded-2xl border border-sky-200 bg-sky-50 p-5 sm:p-6">
              <h2 className="text-2xl font-black text-[#123b2a]">Three mistakes that look reasonable</h2>
              <ul className="mt-4 space-y-3 text-sm font-medium leading-6 text-slate-700">
                <li><strong className="text-[#123b2a]">Playing only your total:</strong> A 15 against dealer 6 is not the same problem as 15 against dealer 10.</li>
                <li><strong className="text-[#123b2a]">Refusing to risk a bust:</strong> Sometimes hitting loses quickly while standing loses politely. Quickly can still be the better decision.</li>
                <li><strong className="text-[#123b2a]">Ignoring pairs and doubles:</strong> Before choosing hit or stand, confirm that split or double is not the preferred play.</li>
              </ul>
            </section>
